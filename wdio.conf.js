const url = require('./url') //configured urls for testing
const ENV = process.new.ENV //configured  environment variables

if(!ENV || !['qa', 'dev', 'staging'].includes(ENV)){
    console.error("Please set the newman environment variable to either qa, dev or staging")
    process.exit()
}
